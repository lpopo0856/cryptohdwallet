...
libs_bitcoin_networks_dogecoin = {
...
libs_bitcoin_networks_litecoinXprv = {
...
libs_bitcoin_networks_bitcoinsv = {
  messagePrefix: 'unused',
  bip32: {
    public: 0x0488b21e,
    private: 0x0488ade4
...
function getExtend(coin_symbol) {
  let result;
  switch (coin_symbol) {
    case "DASH":
      result = libs_bitcoin_networks_dash;
      break;
    case "ZEC":
      result = libs_bitcoin_networks_zcash;
      break;
    case "DOGE":
      result = libs_bitcoin_networks_dogecoin;
      break;
    case "BSV":
      result = libs_bitcoin_networks_bitcoinsv;
      break;
    case "LTC":
      result = libs_bitcoin_networks_litecoinXprv;
      break;
    case "NAV":
      result = libs_bitcoin_networks_navcoin;
      break;
    case "STRAT":
      result = libs_bitcoin_networks_stratis;
      break;
