...
function publicKeyToAddress(childPublicKey, coin_symbol) {
    switch (coin_symbol) {
        case 'ETH':
        ...
        default:
            return (btcUtil.payments.p2pkh({ pubkey: childPublicKey, network: coinExtends.getExtend(coin_symbol) })).address;
    }
}
/**
 * 
